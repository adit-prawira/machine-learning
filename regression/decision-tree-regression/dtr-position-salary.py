...
print(f"\nPrediction with Decision Tree Regression of {position_level} position level: ${salary_prediction}\n")
...
plt.title("Truth or Bluff (Higher Resolution Decision Tree Regression)")
plt.xlabel("Position Level")
plt.ylabel("Salary")
plt.show()